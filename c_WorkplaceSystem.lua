...
isyeriolusturResim = dgsCreateImage(30, 32, 204, 190, "files/resimler/taslak.png", false, mainIsYeriOlusturtab)
isyeriolusturResim1 = dgsCreateImage(30, 32, 204, 190, "files/resimler/market.png", false, mainIsYeriOlusturtab)
isyeriolusturResim2 = dgsCreateImage(30, 32, 204, 190, "files/resimler/giyim.png", false, mainIsYeriOlusturtab)
isyeriolusturResim3 = dgsCreateImage(30, 32, 204, 190, "files/resimler/kurum.png", false, mainIsYeriOlusturtab)
isyeriolusturResim4 = dgsCreateImage(30, 32, 204, 190, "files/resimler/restorant.png", false, mainIsYeriOlusturtab)
isyeriolusturResim5 = dgsCreateImage(30, 32, 204, 190, "files/resimler/sirket.png", false, mainIsYeriOlusturtab)
...
isyeriUnvanlbl1 = dgsCreateLabel(309, 64, 84, 20, "İş Yeri Ünvan", false, mainIsYeriDuzenletab)
...
girisunvanlbl = dgsCreateLabel(22, 12, 244, 21, "➥ İşyeri Ünvanı: ", false, giriswindow)
...
giriscalismasaatlerilbl = dgsCreateLabel(22, 167, 244, 21, "➥ Çalışma Saatleri: ", false, giriswindow)
dgsSetFont(giriscalismasaatlerilbl, font0_Font13)
...
yonetimcizgilbl2 = dgsCreateLabel(4, 195, 527, 15, "⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻⸻", false, yonetimwindow)
yonetimsaatunvantxt = dgsCreateEdit(184, 228, 175, 33, "", false, yonetimwindow)
yonetimunvanbtn = dgsCreateButton(299, 271, 162, 43, "Ünvanı Güncelle", false, yonetimwindow)
dgsSetFont(yonetimunvanbtn, font0_Font13)
yonetimcalismasaatibtn = dgsCreateButton(82, 271, 162, 43, "Çalışma Saatlerini\n Güncelle", false, yonetimwindow)
dgsSetFont(yonetimcalismasaatibtn, font0_Font13)
...
addEventHandler("WorkPlaceSystem:AdminPanel",getRootElement(),function(result)
    ...
    for i,v in pairs(result) do
                ...
                dgsGridListSetItemText(isyeriList1,row,2,v["unvan"])
                ...
                dgsGridListSetItemText(isyeriList2,row2,2,v["unvan"])
